            ...
            <el-col :span="24">
                <el-table :data="tableDate" border >
                    ...
                    <el-table-column label="操作"  width="300">
                        <template scope="scope">
                            <el-button size="mini" type="link"  @click="detailSuppiler(scope.row.customerNo,'detail')">详情</el-button>
                            <el-button size="mini" type="link"  @click="detailLog(scope.row.customerNo)" >日志</el-button>
                            <el-button size="mini" type="link"  @click="detailSuppiler(scope.row.customerNo,'audit')" v-if="scope.row.status =='2'">审核</el-button>
                            <el-button size="mini" type="link"  @click="enabled(scope.row.customerNo)" v-if="(scope.row.scm =='0' && scope.row.status =='3')">开通scm</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-col>
