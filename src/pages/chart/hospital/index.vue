        ...
        <el-row>
            <el-col :span="24" class="toolbar">
                <el-form :inline="true">
                    ...
                    <el-form-item>
                        <el-input placeholder="客户名称" v-model.trim="search.keywords" class="w300" size="small"  @keyup.native.enter="getList(1)"></el-input>
                    </el-form-item>
                    <el-form-item>
            ...
            <el-col :span="24">
                <el-table :data="list" border >
                    ...
                    <el-table-column prop="name" label="客户名称" min-width="150" align="center" >
                    </el-table-column>
...
<script>
    import {parseMone, format} from '~/global.common';
    const URL = {
        PEOPLE_LIST: 'scm.statistics.customerPurchaseByPlatform' // 查询列表
    };
    export default {
        name: 'staff',
        data () {
