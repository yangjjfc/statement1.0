    ...
    <section class="container_setion">
        ...
        <el-row>
            <el-col :span="24" class="toolbar">
                <el-form :inline="true">
                    <el-form-item>
                        <el-select size="small" v-model="search.deliveryType" placeholder="请选择" @change="getList(1)" class="w100">
                            <el-option
                    ...
                    <el-form-item>
                        <el-input placeholder="配送单号/订单编号/出库单号/供应商/客户名称" v-model.trim="search.keys" @keyup.native.enter="getList(1)" class="w300" size="small"></el-input>
                    </el-form-item>
                    <el-form-item>
